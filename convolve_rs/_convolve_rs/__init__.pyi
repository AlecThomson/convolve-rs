...
class Beam:
    ...
    def __new__(
        cls,
        major_deg: builtins.float,
        minor_deg: builtins.float,
        pa_deg: builtins.float,
    ) -> Beam: ...
    @classmethod
    def from_arcsec(
        cls,
        major_arcsec: builtins.float,
        minor_arcsec: builtins.float,
        pa_deg: builtins.float,
    ) -> Beam:
        r"""
...
def common_beam(
    beams: typing.Sequence[Beam],
    tolerance: builtins.float = 0.0001,
    nsamps: builtins.int = 200,
    epsilon: builtins.float = 0.0005,
) -> Beam:
    r"""
...
def gauss_factor(
    conv_beam: Beam,
    orig_beam: Beam,
    dx_arcsec: builtins.float,
    dy_arcsec: builtins.float,
) -> tuple[
    builtins.float, builtins.float, builtins.float, builtins.float, builtins.float
]:
    r"""
...
def smooth(
    image: numpy.typing.NDArray[numpy.float32],
    old_beam: Beam,
    new_beam: Beam,
    dx_deg: builtins.float,
    dy_deg: builtins.float,
    cutoff_arcsec: builtins.float | None = None,
